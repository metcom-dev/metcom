...
from ..reports.ple_inv_and_bal_01_report import ReportInvBalTxt
...
class WizardReportGenerateTxt(models.TransientModel):
    ...
    def generate_data(self):
        ...
        for line in report.line_ids:
            for eeff in line.eeff_ple_ids:
                if eeff.eeff_type != '3.1':
                    continue
                ...
                if values:
                    ...
                    data.append({
                        ...
                        'financial_state_code': eeff.code,
                        'credit': "{:.2f}".format(balance_rubro),
                        'state': '1',
                    })
        return data
    ...
    def action_generate_txt(self):
        ...
        report_20 = ReportInvBalTxt(self, data)
        data = {
    ...
    def action_return_wizard(self):
        wizard_form_id = self.env.ref('ple_inv_and_bal_0301_ee.wizard_report_generate_0301_ee_txt_view').id
        return {
