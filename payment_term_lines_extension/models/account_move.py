...
class AccountMove(models.Model):
    ...
    def _recompute_payment_terms_lines(self):
        ...
        existing_terms_lines = self.line_ids.filtered(
            lambda line: line.account_id.account_type.type in ('receivable', 'payable') or line.date_maturity)
        others_lines = self.line_ids.filtered(
            lambda line: line.account_id.account_type.type not in ('receivable', 'payable') and not line.date_maturity)
