{
    ...
    'summary': 'This module will add the fields "Ubigeo" and "Establishment Annex" in the contact form. These fields are dependency for many modules of the Peruvian localization such as electronic invoicing.',
    'description': """
