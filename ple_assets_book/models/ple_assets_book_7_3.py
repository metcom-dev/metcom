    ...
    def _execute_lines_7_3_depreciation(self):
        def function_lines_7_3_dep_sql():
            lines_1.append({
                ...
                'amount_withdrawals': "{:.2f}".format(asset['amount_total']) if asset['ple_selection'] == 'assets_book_acquisition_amortization' else "{:.2f}".format(0),
        ...
        for asset in self.get_data_7_3_depreciation_sql():
            for line in self.line31_query():
                if asset['move_id'] == line['id']:
